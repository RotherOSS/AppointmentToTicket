...
// --
// $origin: otobo - cfed3c5e056090fe945e87966a18e2f08320a05a - var/httpd/htdocs/js/Core.Agent.AppointmentCalendar.js
// --
...
// RotherOSS / AppointmentToTicket
     ...
     * @name TicketInit
     * @memberof Core.Agent.AppointmentCalendar
     * @param {Object} Fields - Array with references to ticket creation fields.
     * @param {jQueryObject} Fields.$Ticket - drop down with system notification selection.
     * @param {jQueryObject} Fields.$TicketCustomStringDiv - custom selection of system ticket date
     * @description
    ...
    TargetNS.TicketInit = function (Fields) {
        ...
        // disable enable the different custom fields
        if (Fields.$TicketCustomRelativeInput.prop('checked')) {

            // enable relative date fields
            Fields.$TicketCustomRelativeInput.val(1);
            Fields.$TicketCustomRelativeUnitCount.prop('disabled', false).prop('readonly', false);
            Fields.$TicketCustomRelativeUnit.prop('disabled', false);
            Fields.$TicketCustomRelativePointOfTime.prop('disabled', false);

            // disable the custom date time fields
            Fields.$TicketCustomDateTimeInput.val('');
            Fields.$TicketCustomDateTimeDay.prop('disabled', true);
            Fields.$TicketCustomDateTimeMonth.prop('disabled', true);
            Fields.$TicketCustomDateTimeYear.prop('disabled', true);
            Fields.$TicketCustomDateTimeHour.prop('disabled', true);
            Fields.$TicketCustomDateTimeMinute.prop('disabled', true);
        }
        else {

            // enable the custom date time input
            Fields.$TicketCustomDateTimeInput.val(1);
            Fields.$TicketCustomDateTimeInput.prop('checked', true);
            Fields.$TicketCustomDateTimeDay.prop('disabled', false);
            Fields.$TicketCustomDateTimeMonth.prop('disabled', false);
            Fields.$TicketCustomDateTimeYear.prop('disabled', false);
            Fields.$TicketCustomDateTimeHour.prop('disabled', false);
            Fields.$TicketCustomDateTimeMinute.prop('disabled', false);

            // disable relative date fields
            Fields.$TicketCustomRelativeInput.val('');
            Fields.$TicketCustomRelativeInput.prop('checked', false);
        ...
        Fields.$TicketCustomRelativeInput.off('change.AppointmentCalendar').on('change.AppointmentCalendar', function() {

            // handle radio buttons
            Fields.$TicketCustomRelativeInput.prop('checked', true);
            Fields.$TicketCustomDateTimeInput.prop('checked', false);

            // process changes
            TargetNS.TicketInit(Fields);
        });

        Fields.$TicketCustomDateTimeInput.off('change.AppointmentCalendar').on('change.AppointmentCalendar', function() {
...
// RotherOSS / AppointmentToTicket
        TargetNS.TicketInit({
            ...
            $TicketCustomRelativePointOfTime: $('#TicketCustomRelativePointOfTime'),
            $TicketCustomDateTimeInput: $('#TicketCustomDateTimeInput'),
            $TicketCustomDateTimeDay: $('#TicketCustomDateTimeDay'),
            $TicketCustomDateTimeMonth: $('#TicketCustomDateTimeMonth'),
            $TicketCustomDateTimeYear: $('#TicketCustomDateTimeYear'),
            $TicketCustomDateTimeHour: $('#TicketCustomDateTimeHour'),
